...
//acceleration en x et y
double Boule::intensiteeAx()
{
    return acceleration.x()*sin(vitesse.y()*PI/180);
}
double Boule::intensiteeAy()
{
    return acceleration.x()*cos(vitesse.y()*PI/180);
}

//vitesse en x et y
double Boule::intensiteeVx()
{
   return vitesse.x()*sin(vitesse.y()*PI/180);
}
double Boule::intensiteeVy()
{
    return vitesse.x()*cos(vitesse.y()*PI/180);
}
