...
void Boule::collTable()
{
    if(m_empochee == false)
    {
        ...
        {//1
            ...
            cout << "collision bord 1 " <<endl; //m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//2
            ...
            cout << "collision bord 2 " <<endl; //m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//3
            ...
            cout << "collision bord 3 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//4
            vitesse.modifierY(90 - vitesse.y());
            cout << "collision bord 4 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//5
            vitesse.modifierY(270 - vitesse.y());
            cout << "collision bord 5 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//6
            vitesse.modifierY(270 - vitesse.y());
            cout << "collision bord 6 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//7
            vitesse.modifierY(270 - vitesse.y());
            cout << "collision bord 7 " <<endl;// m_x << ";" << m_y << endl; //replacement en x de la boule pour restituer l'énergie perdue lors de l'overshoot
            x = m_x;
        ...
        {//8
            vitesse.modifierY(270 - vitesse.y());
            cout << "collision bord 8 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//9
            vitesse.modifierY(90 - vitesse.y());
            cout << "collision bord 9 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//10
            vitesse.modifierY(270 - vitesse.y());
            cout << "collision bord 10 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//11
            vitesse.modifierY(90 - vitesse.y());
            cout << "collision bord 11 " << endl;//m_x << ";" << m_y << endl;
            x = m_x;
        ...
        {//12
            vitesse.modifierY(90 - vitesse.y());
            cout << "collision bord 12 " <<endl;// m_x << ";" << m_y << endl;
            x = m_x;
...
//collision avec les coins
        ...
        {//1b a revoir
            ...
            cout << "collision coin 1 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
        ...
        {//2b ok
            ...
            cout << "collision coin 2 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
        ...
        {//3b a revoir
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 3 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//4b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 4 " << endl;//m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//5b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 5 " << endl;//m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//6b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 6 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//7b a revoir
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 7 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//8b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 8 " << endl;//m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//9b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 9 " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//10b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 10 " << endl;//m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//11b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 11  " <<endl;// m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        {//12b ok
            ...
            double b = 2*tan(gamma)*(m_y-(tan(gamma)*m_x)-y0)-2*x0; //coef de x
            double c = (m_y-(tan(gamma)*m_x)-y0)*(m_y-(tan(gamma)*m_x)-y0) - m_r*m_r + x0*x0;
            cout << "collision coin 12 " << endl;//m_x << ";" << m_y << " " << vitesse.y() << endl;
            double xb1 = (-b + sqrt(b*b - 4*a*c))/(2*a);
            double xb2 = (-b - sqrt(b*b - 4*a*c))/(2*a);
            double yb1 = tan(gamma)*xb1 + m_y -(tan(gamma)*m_x);
            double yb2 = tan(gamma)*xb2 + m_y -(tan(gamma)*m_x);
        ...
        else if(m_x-m_r <= 0.04 and m_y <= 1.1865 and m_y >= 0.0835)
        {
            ...
            cout << "TABLE 3 BOULE : " << m_numero << endl;//" " << m_x << " ; " << m_y << endl;
        }
        ...
        else if(m_x+m_r >= LONGUEUR-0.04 and m_y <= 1.1865 and m_y >= 0.0835)
        {
            ...
            cout << "TABLE 4 BOULE : " << m_numero << endl;//" " << m_x << " ; " << m_y << endl;
        }
        ...
        {
            cout << "TABLE 5 BOULE : " << m_numero <<endl;// " " << m_x << " ; " << m_y << endl;
        ...
        {
            cout << "TABLE 6 BOULE " << m_numero << endl;//" " << m_x << " ; " << m_y << endl;
            vitesse.modifierY(180 - vitesse.y());
            m_y = (LARGEUR-0.04)*2 - m_y - 2*m_r;
        }
        ...
        {
            cout << "TABLE 1 BOULE " << m_numero <<endl;// " " << m_x << " ; " << m_y << endl;
            vitesse.modifierY(180 - vitesse.y());
        ...
        {
            cout << "TABLE 2 BOULE " << m_numero <<endl;// " " << m_x << " ; " << m_y << endl;
            vitesse.modifierY(180 - vitesse.y());
            m_y = 2*0.04-m_y + 2*m_r;
        }
